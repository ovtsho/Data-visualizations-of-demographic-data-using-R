---
title: "Data visualizations of demographic data using R"
...
These visualizations were prepared using different approaches and R packages. The goal was to explore some differences in populations in countries across the world. 
...
Then, activate all packages (previously they could be installed with install.packages('')).
...
Let's use a line plot to compare changes in population in the years 1995-2013 in Australia, Romania, and Nepal.
...
Let's compare the population of Canada, Bangladesh, 
Argentina, Belgium, Brazil, and Bulgaria in 2013 with bar plot. 
